    ...
    return (
        <div className="messageSender">
            ...
            <div className="messageSender__bottom">
                ...
                <div className="messageSender__option" onClick={() => {
                ...
                <div className="popup__show">
                    ...
                    <div className="popup__body">
                        <div className="popup__body--name">
                            ...
                            <div className="popup__name">
                                ...
                                <div className="popup__icon">
                                    ...
                                    <p style={{ paddingBottom: '.3rem', paddingLeft: '.3rem' }}>public</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="popup__body--input">
                            <CropOriginalIcon /> <input id="popupImg__value" onChange={(e) => {
                                setImage(e.target.value)
                            }} type="text" placeholder="Put your url image here!" />
                        </div>
                    </div>
                    <div className="popup__bottom">
                        <div onClick={handleSubmitPost} className="popup__bottom--button">Post</div>
                    </div>
                </div>
            </div>
            ...
            <div id="popup2" className="popup">
                ...
                <div className="popup__show">
                    ...
                    <div className="popup__body">
                        ...
                        <div className="popup__body--input">
                            <CropOriginalIcon /> <input id="popupImg__value2" onChange={(e) => {
                                setImage2(e.target.value)
                            }} type="text" placeholder="Put your url image here!" />
                        </div>
                    </div>
                    <div className="popup__bottom">
                        <div onClick={handleSubmitPost2} className="popup__bottom--button">Post</div>
                    </div>
                </div>
            </div>
        </div>
